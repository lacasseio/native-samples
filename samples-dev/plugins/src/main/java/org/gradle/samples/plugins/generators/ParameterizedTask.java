...
/*private*/ interface ParameterizedTask<P extends ParameterizedTask.Parameters> extends Task {
	...
	static <T extends ParameterizedTask<P>, P extends Parameters> Class<T> type(Class<P> type) {
