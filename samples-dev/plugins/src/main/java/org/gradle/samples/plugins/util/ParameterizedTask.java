...
public interface ParameterizedTask<P extends ParameterizedTask.Parameters> extends Task {
	...
	abstract class UsingWorker<P extends ParameterizedTask.Parameters & WorkParameters & UsingWorker.CopyTo<P>> extends DefaultTask implements ParameterizedTask<P> {
